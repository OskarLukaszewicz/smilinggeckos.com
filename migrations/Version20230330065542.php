 ...
 */
final class Version20230330065542 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE gecko ADD COLUMN requested_for_reservation BOOLEAN NOT NULL DEFAULT FALSE');
    }
